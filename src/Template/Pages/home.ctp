<section class="slick-slideshow">   
                <div class="slick-custom">
                    <?= $this->Html->image("slideshow/medium-shot-business-women-high-five.jpeg",["class"=>"img-fluid","alt"=>""]) ?>
                ...
                <div class="slick-custom">
                    <?= $this->Html->image("slideshow/team-meeting-renewable-energy-project.jpeg",["class"=>"img-fluid","alt"=>""]) ?>
                ...
                <div class="slick-custom">
                    <?= $this->Html->image("slideshow/two-business-partners-working-together-office-computer.jpeg",["class"=>"img-fluid","alt"=>""]) ?>
                    <div class="slick-bottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
