<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Start Navbar Links-->
                    ...
                    <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                        ...
                        <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <?= $this->Html->image('user2-160x160.jpg',['class'=>'user-image rounded-circle shadow','alt'=>'User Image']) ?>  <span class="d-none d-md-inline"><?= $userData['name'] ?></span> </a>
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                                <li class="user-header text-bg-primary"> <img src="../../dist/assets/img/user2-160x160.jpg" class="rounded-circle shadow" alt="User Image">
                                    <p>
                                        <?= $userData['name'].' - '.$userData['role']['name'] ?> 
                                        <small>Member since <?= $this->Time->nice($userData['created']) ?></small>
                                    </p>
                                ...
                                <li class="user-footer"> 
                                    ...
                                    ['class'=>'btn btn-default btn-flat float-end','escape'=>false]) ?> 
